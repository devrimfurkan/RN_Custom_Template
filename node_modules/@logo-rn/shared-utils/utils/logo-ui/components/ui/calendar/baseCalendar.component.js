...
class BaseCalendarComponent extends react_1.default.Component {
    constructor() {
        ...
        this.renderWeekdayElement = (weekday, index) => {
            return (react_1.default.createElement(calendarDateContent_component_1.CalendarDateContent, { key: index, textStyle: this.getWeekdayStyle(this.props.leds.style) }, weekday));
        };
    ...
    render() {
        const { leds, style, ...viewProps } = this.props;
        const evaStyle = this.getCalendarStyle(leds.style);
