...
const { TEXT_COLOR_50 } = require("../../../../constants");
...
let Toggle = class Toggle extends react_1.default.Component {
    constructor(props) {
        ...
        this.onPanResponderGrant = (event) => {
            const { checked, disabled, leds } = this.props;
            if (disabled) {
                return;
            }
            ...
            this.animateThumbWidth(leds.style.thumbWidth * 1.2);
        ...
        this.onPanResponderRelease = (event, gestureState) => {
            ...
            this.animateThumbWidth(leds.style.thumbWidth);
        ...
        this.onMouseEnter = (event) => {
            ...
            this.props.leds.dispatch([theme_1.Interaction.HOVER]);
        ...
        this.onFocus = (event) => {
            ...
            this.props.leds.dispatch([theme_1.Interaction.FOCUSED]);
        ...
        this.onPressIn = (event) => {
            this.props.leds.dispatch([theme_1.Interaction.ACTIVE]);
        ...
        this.toggle = (callback = (nextValue) => null) => {
            ...
            this.animateThumbWidth(this.props.leds.style.thumbWidth);
        };
        const { checked, leds } = props;
        this.thumbWidthAnimation = new react_native_1.Animated.Value(leds.style.thumbWidth);
    ...
    render() {
        const { leds, style, checked, children, testID, ...touchableProps } = this.props;
        const evaStyle = this.getComponentStyle(leds.style);
        return (react_1.default.createElement(react_native_1.View, Object.assign({ testID: testID }, this.panResponder.panHandlers, { style: [styles.container] }),
            react_1.default.createElement(devsupport_1.TouchableWeb, Object.assign({}, touchableProps, { style: styles.toggleContainer, onMouseEnter: this.onMouseEnter, onMouseLeave: this.onMouseLeave, onFocus: this.onFocus, onBlur: this.onBlur }),
                ...
                react_1.default.createElement(react_native_1.Animated.View, { style: [evaStyle.ellipseContainer, styles.ellipseContainer, style] },
