...
const { TEXT_COLOR_50, TEXT_COLOR_5, TEXT_COLOR_10 } = require("../../../../constants");
...
let Input = class Input extends react_1.default.Component {
    ...
    render() {
        const { leds, style, textStyle, label, caption, accessoryLeft, accessoryRight, testID, ...textInputProps } = this.props;
        ...
        return (react_1.default.createElement(devsupport_1.TouchableWithoutFeedback, { testID: testID, style: evaStyle.container, onPress: this.focus },
            ...
            react_1.default.createElement(react_native_1.View, { style: [evaStyle.inputContainer, styles.inputContainer, style] },
