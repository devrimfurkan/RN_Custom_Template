...
class BaseDatepickerComponent extends react_1.default.Component {
    constructor() {
        ...
        this.getComponentStyle = (style) => {
            ...
            const { TEXT_COLOR, TEXT_COLOR_10 } = COLORS;
            return {
                control: {
                    ...controlParameters,
                    borderWidth: 0,
        ...
        this.renderInputElement = (props, evaStyle, style) => {
            return (react_1.default.createElement(devsupport_1.TouchableWithoutFeedback, Object.assign({}, props, { style: [evaStyle.control, styles.control, this.props.controlStyle, style], onPress: this.onPress, onPressIn: this.onPressIn, onPressOut: this.onPressOut }),
    ...
    render() {
        const { leds, style, testID, backdropStyle, controlStyle, placement, label, accessoryLeft, accessoryRight, caption, ...touchableProps } = this.props;
