...
let List = class List extends react_1.default.Component {
    ...
    render() {
        const { leds, style, keyExtractor, ...flatListProps } = this.props;
        return (react_1.default.createElement(react_native_1.FlatList, Object.assign({ keyExtractor: keyExtractor || this.keyExtractor }, flatListProps, { ref: this.listRef, style: [leds.style, style] })));
    }
};
List = __decorate([
    theme_1.styled('List')
